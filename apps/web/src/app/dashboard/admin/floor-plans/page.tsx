...
export default function FloorPlansPage() {
    ...
    const updateTableProperty = (id: string, property: string, value: any) => {
        setTables(prev => prev.map(t => t.id === id ? { ...t, [property]: value } : t));
        if (selectedTable?.id === id) {
            setSelectedTable((prev: any) => ({ ...prev, [property]: value }));
        }
    };
    ...
    return (
        <PageContainer
            ...
            description="Visual Layout Manager"
            actions={
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        ...
                        <div className="lg:col-span-3 space-y-4">
                            ...
                            >
                                ...
                                {/* Table Rendering */}
                                {tables.filter(t => t.floor === selectedFloor).map(table => (
                                    <div
                                        key={table.id}
