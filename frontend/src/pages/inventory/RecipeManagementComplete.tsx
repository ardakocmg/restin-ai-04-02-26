      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="max-w-3xl">
          ...
          <div className="space-y-4">
            <div>
              <label style={{ color: '#D4D4D8' }}>Recipe Name</label> /* keep-inline */
              <Input
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label style={{ color: '#D4D4D8' }}>Yield Quantity</label> /* keep-inline */
                <Input
                  type="number"
              ...
              <div>
                <label style={{ color: '#D4D4D8' }}>Yield Unit</label> /* keep-inline */
                <Input
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label style={{ color: '#D4D4D8' }}>Components</label> /* keep-inline */
