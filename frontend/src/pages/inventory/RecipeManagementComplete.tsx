      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="max-w-3xl">
          ...
          <div className="space-y-4">
            <div>
              <label style={{ color: '#D4D4D8'  /* keep-inline */ }} /* keep-inline */>Recipe Name</label> /* keep-inline */ /* keep-inline */ /* keep-inline */
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label style={{ color: '#D4D4D8'  /* keep-inline */ }} /* keep-inline */>Yield Quantity</label> /* keep-inline */ /* keep-inline */ /* keep-inline */
                <Input aria-label="Input field"
                  type="number"
              ...
              <div>
                <label style={{ color: '#D4D4D8'  /* keep-inline */ }} /* keep-inline */>Yield Unit</label> /* keep-inline */ /* keep-inline */ /* keep-inline */
                <Input aria-label="Input field"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label style={{ color: '#D4D4D8'  /* keep-inline */ }} /* keep-inline */>Components</label> /* keep-inline */ /* keep-inline */ /* keep-inline */
