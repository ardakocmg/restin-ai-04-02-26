...
export default function Login() {
  ...
  const [loginTarget, setLoginTarget] = useState("pos"); // Default to POS
  ...
  // Auto-submit when PIN reaches 4 digits (faster)
  useEffect(() => {
  ...
  const resetPinWithError = () => {
    ...
    setTimeout(() => {
      setPin("");
      setPinError(false);
    }, 300); // Faster error clear (was 500ms)
  };
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Select value={selectedVenue} onValueChange={setSelectedVenue}>
                  <SelectTrigger className="bg-zinc-800 border-white/10 text-white h-12">
