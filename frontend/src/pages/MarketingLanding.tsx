      ...
      <header className="sticky top-0 z-40 px-6 lg:px-12 py-4 bg-white/80 backdrop-blur-xl border-b border-gray-200" data-testid="marketing-nav">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4" data-testid="marketing-brand">
            ...
            <div>
              <div className="text-lg font-bold tracking-tight text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>restin.ai</div>
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <section className="pt-16 pb-24" data-testid="marketing-hero">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-start">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-[1.08] tracking-tighter text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid="marketing-hero-title">
              ...
              <div className="grid grid-cols-3 gap-4" data-testid="marketing-hero-metrics">
                {(hero.metrics || defaultContent.hero.metrics).map(metric => (
                  <div key={metric.key} className="light-card p-5" data-testid={`marketing-stat-${metric.key}`}>
                    <div className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{metric.value}</div>
        ...
        <section id="features" className="pb-24 scroll-mt-20" data-testid="marketing-features-section">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold tracking-tight text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Built different, by design</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map(feature => (
              <div key={feature.key} className="light-card p-6" data-testid={`marketing-feature-${feature.key}`}>
                ...
                <h3 className="text-lg font-bold text-foreground mb-2" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{feature.title}</h3>
        ...
        <section id="modules" className="pb-24 scroll-mt-20" data-testid="marketing-modules-section">
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <h2 className="text-4xl font-bold tracking-tight text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid="marketing-modules-title">Modules built to scale</h2>
            ...
            {modulesList.map(mod => (
              <div key={mod.key} className={`light-card p-6 ${mod.status === 'coming_soon' ? 'opacity-70' : ''}`} data-testid={`marketing-module-${mod.key}`}>
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-base font-bold text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{mod.title}</h3>
        ...
        <section id="pricing" className="pb-24 scroll-mt-20" data-testid="marketing-pricing-section">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold tracking-tight text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid="pricing-title">Pricing aligned to EU market averages</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {pricingList.map(plan => (
              <div key={plan.key} className={`light-card p-7 relative ${plan.popular ? 'ring-2 ring-red-500/30 shadow-lg' : ''}`} data-testid={`pricing-card-${plan.key}`}>
                ...
                <h3 className="text-xl font-bold text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid={`pricing-name-${plan.key}`}>{plan.name}</h3>
                <div className="mt-4 flex items-end gap-2" data-testid={`pricing-price-${plan.key}`}>
                  <span className="text-5xl font-bold tracking-tight text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{plan.price}</span>
        ...
        <section id="roadmap" className="pb-24 scroll-mt-20" data-testid="marketing-roadmap-section">
          <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-bold tracking-tight text-gray-900" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid="roadmap-title">Future roadmap</h2>
        ...
        <section className="pb-24" data-testid="marketing-final-cta">
          <div className="relative">
            <div className="relative p-12 rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xl">
              <div>
                <h2 className="text-4xl font-bold tracking-tight text-foreground" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid="marketing-final-cta-title">{cta.title}</h2>
