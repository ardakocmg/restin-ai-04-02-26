...
export default function TechnicalHub() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#050505]" style={{ color: '#F5F5F7' }} data-testid="technical-hub-page"> /* keep-inline */ /* keep-inline */
      <style>{`
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl font-bold tracking-tight text-foreground" style={{ fontFamily: 'Space Grotesk, sans-serif' }}> /* keep-inline */ /* keep-inline */
        ...
        <section id="technical-content" className="mb-24">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-start">
            <div className="space-y-8">
              ...
              <h2 className="text-5xl lg:text-7xl font-bold leading-[1.1] tracking-tighter text-foreground" style={{ fontFamily: 'Space Grotesk, sans-serif' }}> /* keep-inline */ /* keep-inline */
