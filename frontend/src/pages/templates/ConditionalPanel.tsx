...
export default function ConditionalPanel({ selectedBlock }: ConditionalPanelProps) {
    ...
    if (!selectedBlock) {
        return <div className="ts-props-empty"><p style={{ fontSize: 13 }}>{t('Select a block first')}</p></div>; /* keep-inline */ /* keep-inline */ /* keep-inline */
    }
        ...
        <div style={{ animation: 'ts-fadeIn 0.2s ease-out' }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
            ...
            <div className="ts-condition-row">
                <div>
                    ...
                    <select title={t('Field')} className="ts-select" style={{ fontSize: 11 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                ...
                <div>
                    ...
                    <select title={t('Operator')} className="ts-select" style={{ fontSize: 11 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
            ...
            <div className="ts-row" style={{ marginTop: 8 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                <span style={{ fontSize: 10, color: 'var(--muted-foreground)' }}>Sz 24 V</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
            </div>
        </div>
    );
}
