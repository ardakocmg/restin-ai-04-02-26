...
export default function ConditionalPanel({ selectedBlock }: ConditionalPanelProps) {
    ...
    if (!selectedBlock) {
        return <div className="ts-props-empty"><p style={{ fontSize: 13 }}>{t('Select a block first')}</p></div>; /* keep-inline */
    }
        ...
        <div style={{ animation: 'ts-fadeIn 0.2s ease-out' }}> /* keep-inline */
            <div className="ts-field">
                <div className="ts-checkbox-row">
                    ...
                    <label htmlFor="ts-gated" style={{ fontWeight: 600 }}>{t('Gated')}</label> /* keep-inline */
                </div>
                <p style={{ fontSize: 11, color: 'var(--muted-foreground)', marginTop: 4 }}> /* keep-inline */
            ...
            <div className="ts-condition-row">
                <div>
                    ...
                    <select title={t('Field')} className="ts-select" style={{ fontSize: 11 }}> /* keep-inline */
                ...
                <div>
                    ...
                    <select title={t('Operator')} className="ts-select" style={{ fontSize: 11 }}> /* keep-inline */
                ...
                <div>
                    ...
                    <input type="text" className="ts-input" style={{ fontSize: 11 }} placeholder="..." /> /* keep-inline */
                </div>
            </div>

            <div className="ts-row" style={{ marginTop: 8 }}> /* keep-inline */
                <span style={{ fontSize: 10, color: 'var(--muted-foreground)' }}>Sz 24 V</span> /* keep-inline */
            </div>
        </div>
    );
}
