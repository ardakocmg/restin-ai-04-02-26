                ...
                <div className="ts-sidebar">
                    ...
                    {sidebarTab === 'assets' && (
                        <div className="ts-blocks-panel">
                            ...
                            <input ref={assetInputRef} type="file" accept="image/*" onChange={handleAssetUpload} style={{ display: 'none' }}  aria-label="Input field" />
                        </div>
                    )}
                    ...
                    {sidebarTab === 'imports' && (
                        <div className="ts-blocks-panel">
                            ...
                            <input ref={fileInputRef} type="file" accept=".json" onChange={importTemplate} style={{ display: 'none' }}  aria-label="Input field" />
                        </div>
                    )}
