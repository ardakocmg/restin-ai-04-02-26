        ...
        <div className="ts-root">
            ...
            <div className="ts-toolbar">
                ...
                <div className="ts-zoom">
                    ...
                    <span style={{ minWidth: 32, textAlign: 'center' }}>{zoom}%</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                ...
                <div className="ts-sidebar">
                                ...
                                <div key={pr.name} className="ts-printer-card">
                                    <div className="ts-printer-card-header">
                                        ...
                                        <span className={`ts-printer-status ${pr.online ? 'online' : 'offline'}`}>
                                            {pr.online ? <><Wifi style={{ width: 10, height: 10 }} /> Online</> : <><WifiOff style={{ width: 10, height: 10 }} /> Offline</>} /* keep-inline */ /* keep-inline */ /* keep-inline */
                                        </span>
                                    </div>
                    ...
                    {sidebarTab === 'assets' && (
                        <div className="ts-blocks-panel">
                            ...
                            <input ref={assetInputRef} type="file" accept="image/*" onChange={handleAssetUpload} style={{ display: 'none' }}  aria-label="Input field" /> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        </div>
                    )}
                    ...
                    {sidebarTab === 'imports' && (
                        <div className="ts-blocks-panel">
                            ...
                            <input ref={fileInputRef} type="file" accept=".json" onChange={importTemplate} style={{ display: 'none' }}  aria-label="Input field" /> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        </div>
                    )}
                ...
                {viewMode === 'canvas' ? (
                    ...
                    >
                        <div className="ts-paper" style={{ width: paperWidthPx }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            ...
                            {/* Paper content */}
                            <div className="ts-paper-content" style={{ /* keep-inline */ /* keep-inline */ /* keep-inline */
                                    ...
                                    <React.Fragment key={block.id as string}>
                                        ...
                                        >
                                            <div className="ts-row" style={{ gap: 4 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                                ...
                                                <div style={{ flex: 1 }}><CanvasBlockRenderer block={block} /></div> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                            </div>
                                ...
                                <div className="ts-grid-2">
                                    ...
                                    <div className="ts-field">
                                        ...
                                        <div className={`ts-type-chip ${templateStatus === 'active' ? 'active-chip' : 'normal'}`} style={{ marginTop: 4 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                            {templateStatus === 'active' ? <><CheckCircle style={{ width: 12, height: 12 }} /> {t('Published')}</> : t(templateStatus)} /* keep-inline */ /* keep-inline */ /* keep-inline */
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div style={{ /* keep-inline */ /* keep-inline */ /* keep-inline */
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 24px', borderBottom: '1px solid var(--border)' }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            <div className="ts-row" style={{ gap: 8 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                ...
                                <span style={{ fontSize: 15, fontWeight: 600, color: 'var(--foreground)' }}>{t('Preview')}</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            </div>
