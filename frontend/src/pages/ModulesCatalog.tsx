            ...
            <header className="sticky top-0 z-40 px-6 lg:px-12 py-5 bg-black/40 backdrop-blur-xl border-b border-border" data-testid="modules-nav">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="text-lg font-bold tracking-tight" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Module Catalog</div>
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                                {modules.map((mod, i) => (
                                    ...
                                    >
                                        ...
                                        {/* Title & Description */}
                                        <h3 className="text-sm font-bold text-foreground mb-1.5" style={{ fontFamily: 'Space Grotesk, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                            {mod.title}
                                        </h3>
