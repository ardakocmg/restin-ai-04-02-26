            ...
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-zinc-900/50 border border-white/5">
                    ...
                    <p className="text-[10px] text-zinc-500 font-bold leading-relaxed uppercase tracking-tight">
                        <span className="text-zinc-400">Data Guard:</span> All incoming files are scanned for structural integrity. Duplicates are automatically merged based on unique identifiers (Punch Card ID / Employee Code).
                    </p>
                </div>
            </div>
