    ...
    return (
        <PermissionGate requiredRole="MANAGER">
            <div className="bg-white text-black min-h-screen p-8 max-w-[210mm] mx-auto font-sans text-sm print:p-0 print:max-w-none">
                ...
                {/* Employee Info */}
                <div className="grid grid-cols-2 gap-8 mb-8 bg-background p-4 rounded-lg border border-border print:border-none print:bg-transparent print:p-0">
                    <div>
                        <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold mb-1">Employee</p>
                    ...
                    <div className="text-right">
                        <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold mb-1">Pay Period</p>
                        <p className="font-bold">{run.period_start} - {run.period_end}</p>
                        <div className="mt-2">
                            <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold mb-1">ID Card</p>
                            <p>123456M</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-8">
                    <table className="w-full">
                        ...
                        <tfoot className="border-t-2 border-gray-800 bg-background print:bg-transparent">
                            <tr>
                ...
                <div className="flex justify-end mb-12">
                    <div className="bg-gray-900 text-foreground p-6 rounded-xl print:bg-transparent print:text-black print:border-2 print:border-black">
                ...
                <div className="fixed bottom-8 right-8 print:hidden">
                    <button
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-foreground font-bold py-3 px-6 rounded-full shadow-lg flex items-center gap-2"
                    >
                        Print Payslip
                    </button>
                </div>
