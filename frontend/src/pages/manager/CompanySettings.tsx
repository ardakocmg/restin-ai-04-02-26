...
export default function CompanySettings() {
    ...
    return (
        <PageContainer
            ...
            actions={
                <Button onClick={handleSave} disabled={loading || !canEdit} className="bg-red-600 hover:bg-red-700 text-foreground font-bold uppercase tracking-wider h-10 px-8 shadow-lg disabled:opacity-50">
        ...
        >
            <Tabs defaultValue="details" className="w-full">
                <div className="flex items-center justify-between mb-8 border-b border-border overflow-x-auto">
                    <TabsList className="bg-transparent h-12 w-auto justify-start p-0">
                        <TabsTrigger value="details" className="data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-red-500 rounded-none h-12 px-6 text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Company Details</TabsTrigger>
                        <TabsTrigger value="identity" className="data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-red-500 rounded-none h-12 px-6 text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Venue Identity</TabsTrigger>
                        <TabsTrigger value="regional" className="data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-red-500 rounded-none h-12 px-6 text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Regional & Tax</TabsTrigger>
                        <TabsTrigger value="zones" className="data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-red-500 rounded-none h-12 px-6 text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Service Zones</TabsTrigger>
                        <TabsTrigger value="tables" className="data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-red-500 rounded-none h-12 px-6 text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Physical Tables</TabsTrigger>
                        <TabsTrigger value="import" className="data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-red-500 rounded-none h-12 px-6 text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Wizard</TabsTrigger>
                    </TabsList>
                </div>
                    ...
                    <Card className="border-border bg-card/50 backdrop-blur-xl">
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex items-center justify-between p-4 bg-background rounded-lg border border-border col-span-2">
                                    <div>
                                        <Label className="text-sm font-bold text-foreground">Enable Table Pacing</Label>
                                        <p className="text-xs text-muted-foreground">Automatically manage reservation flow</p>
                                    </div>
                                    <Switch
                    ...
                    <Card className="border-border bg-card/50">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                <Button size="sm" className="bg-secondary text-foreground">
                                ...
                                columns={[
                                    { key: 'name', label: 'Zone Name' },
                                    {
                                        key: 'type', label: 'Type', render: (row) => (
                                            <Badge variant="outline" className="border-border">{row.type}</Badge>
                                        )
                                    }
                                ]}
                                data={zones}
                ...
                <TabsContent value="import">
                    <Card className="border-border bg-card/50 p-12 flex flex-col items-center justify-center text-center">
                        <div className="h-12 w-12 rounded-full bg-secondary flex items-center justify-center mb-4">
                            <Building2 className="h-6 w-6 text-red-500" />
                        </div>
                        <h3 className="text-lg font-bold text-foreground mb-2">Import/Export Wizard</h3>
                        <p className="text-sm text-muted-foreground max-w-sm mb-6">Bulk upload configuration, menus, and data via CSV or Excel mapping.</p>
                        <Button variant="outline" className="border-border hover:bg-secondary" onClick={() => window.location.href = '/manager/menu-import'}>Start Import Wizard</Button>
                    </Card>
                </TabsContent>
            </Tabs>
        </PageContainer>
