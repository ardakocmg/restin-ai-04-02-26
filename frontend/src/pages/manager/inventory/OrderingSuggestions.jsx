...
function SeasonalityIcon({ factor }) {
    ...
    const icons = {
        ...
        rainy_dip: { icon: CloudRain, label: 'Rainy Dip', className: 'text-zinc-400' },
                ...
                <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-4 text-xs text-muted-foreground">
                            ...
                            <div className="text-center"><span className="font-bold text-zinc-400">{suggestions.filter(s => s.forecast_trend === 'stable').length}</span><br />Stable</div>
