...
function ChainNode({ label, icon: Icon, color, count, sublabel }: {
    ...
    return (
        ...
        )} style={{ borderColor: `var(--${color})` }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
            <Icon className={cn('h-4 w-4 flex-shrink-0', `text-${color}`)} style={{ color: `var(--${color})` }} /> /* keep-inline */ /* keep-inline */ /* keep-inline */
