    ...
    <PageContainer>
      ...
      <div className="flex items-center gap-2 mb-3 flex-wrap">
        ...
        <div className="relative">
          ...
          >
            <option value="active" style={{ backgroundColor: '#18181b', color: '#e4e4e7' }}>Active ({stats.total_active || 0})</option> /* keep-inline */
            <option value="archived" style={{ backgroundColor: '#18181b', color: '#e4e4e7' }}>Archived ({stats.total_archived || 0})</option> /* keep-inline */
            <option value="trash" style={{ backgroundColor: '#18181b', color: '#e4e4e7' }}>Trash ({stats.total_trash || 0})</option> /* keep-inline */
          </select>
          <div className="pointer-events-none absolute inset-y-0 right-2 flex items-center">
            <svg className="w-3 h-3" style={{ color: viewMode === 'active' ? '#34D399' : viewMode === 'archived' ? '#FBBF24' : '#F87171' }} fill="none" stroke="currentColor" viewBox="0 0 24 24"> /* keep-inline */
