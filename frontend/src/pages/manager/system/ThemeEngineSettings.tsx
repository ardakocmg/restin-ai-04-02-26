                                        ...
                                        >
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex gap-2">
                                                    <div className="h-10 flex-1 rounded" style={{ backgroundColor: theme.primary  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ title="Primary" />
                                                    <div className="h-10 flex-1 rounded" style={{ backgroundColor: theme.accent  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ title="Accent" />
                                                </div>
                                                <div className="flex gap-2">
                                                    <div className="h-4 flex-1 rounded" style={{ backgroundColor: theme.success  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ title="Success" />
                                                    <div className="h-4 flex-1 rounded" style={{ backgroundColor: theme.warning  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ title="Warning" />
                                                    <div className="h-4 flex-1 rounded" style={{ backgroundColor: theme.danger  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ title="Danger" />
                                                </div>
                                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border border-border p-6 rounded-xl bg-card/30">
                                    ...
                                    <div className="flex flex-col h-full">
                                        ...
                                        <div className="flex-1 border-2 rounded-xl p-6 bg-background space-y-6" style={{ borderColor: customThemeObj.primary  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                            <div className="space-y-2">
                                                <h3 className="text-lg font-bold" style={{ color: customThemeObj.primary  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Mock Header</h3>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                <Badge style={{ backgroundColor: customThemeObj.success, color: '#ffffff'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{"Success"} Node</Badge>
                                                <Badge style={{ backgroundColor: customThemeObj.warning, color: '#ffffff'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Warning Flag</Badge>
                                                <Badge style={{ backgroundColor: customThemeObj.danger, color: '#ffffff'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{"Error "}Alert</Badge>
                                            </div>
