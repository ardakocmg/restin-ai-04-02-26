            ...
            <div className="flex-1 flex items-center justify-center relative w-full min-h-[260px] z-10">
                <div className="relative w-full max-w-[850px] h-[260px]">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-44 h-44 flex items-center justify-center z-10">
                        ...
                        <div className="absolute inset-0 border-2 border-dashed border-[#00FF00]/30 rounded-full animate-[spin_10s_linear_infinite]" style={{ maskImage: "radial-gradient(transparent 65%, black 65%)", WebkitMaskImage: "radial-gradient(transparent 65%, black 65%)" }}></div> /* keep-inline */ /* keep-inline */ /* keep-inline */
