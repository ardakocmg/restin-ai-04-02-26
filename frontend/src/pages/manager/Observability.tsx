    ...
    >
      ...
      <div className="mb-8 p-6 rounded-2xl bg-background/50 border border-border shadow-inner">
        ...
        <div className="space-y-8">
          {/* Infrastructure */}
          <div>
            <h4 className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground mb-4 ml-1">Cloud Infrastructure</h4>
...
const Badge = ({ children, variant, className }) => (
  <span className={cn(
    ...
    variant === 'outline' ? "border" : "bg-primary text-foreground",
    className
  )}>
    {children}
  </span>
