                ...
                <div className="bg-slate-900 border border-slate-800 p-3 rounded-lg shadow-xl z-50">
                    ...
                    {payload.map((entry, index) => (
                        <div key={index} className="flex items-center gap-2 text-sm">
                            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: entry.color }} /> /* keep-inline */
        ...
        <PermissionGate requiredRole="MANAGER">
            <div className="p-6 bg-background dark:bg-black min-h-screen space-y-6">
                ...
                <Card className="bg-background border-border">
                    ...
                    <CardContent>
                        <div className="h-[400px] w-full mt-4" style={{ minHeight: '400px', minWidth: 0 }}> /* keep-inline */
