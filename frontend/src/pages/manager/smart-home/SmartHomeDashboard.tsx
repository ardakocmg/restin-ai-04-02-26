...
function StatCard({ label, value, icon: Icon, gradient, delay }: { label: string; value: number; icon: React.ElementType; gradient: string; delay: number }) {
    return (
        ...
        >
            ...
            <div className="absolute inset-0 opacity-[0.03]" style={{ background: `linear-gradient(135deg, ${gradient})`  /* keep-inline */ }} />
        ...
        >
            ...
            {device.online && (
                <div
                    ...
                    style={{ background: `radial-gradient(circle, ${cfg.glow}, transparent 70%)`  /* keep-inline */ }}
                />
            )}
