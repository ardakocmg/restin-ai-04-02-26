        ...
        <div className="pulse-tooltip">
            ...
            {payload.map((p, i) => (
                <div key={i} className="flex items-center gap-2 mt-1">
                    <Circle className="w-2 h-2 fill-current pulse-tooltip-dot" style={{ '--dot-color': p.color } as React.CSSProperties} /> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            <div className="flex-1 h-1.5 bg-secondary rounded-full overflow-hidden">
                                                <div
                                                    ...
                                                    style={{ '--bar-width': `${widthPct}%` } as React.CSSProperties} /* keep-inline */ /* keep-inline */ /* keep-inline */
                                                />
                                            </div>
