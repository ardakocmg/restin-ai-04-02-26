            ...
            <div className="p-6 bg-slate-50 dark:bg-black min-h-screen space-y-6">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <a href="/pos/runtime" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-teal-600 to-teal-500 text-white text-sm font-semibold shadow-lg shadow-teal-500/20 hover:shadow-teal-500/40 hover:from-teal-500 hover:to-teal-400 transition-all">
                                        ...
                                        <div className="flex bg-slate-100 dark:bg-slate-900 p-1 rounded-md">
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    taxInclusive
                                                        ? "bg-white text-black dark:bg-slate-800 dark:text-white ring-1 ring-black/5 dark:ring-white/10"
