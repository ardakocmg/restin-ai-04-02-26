  ...
  return (
    <PageContainer title="Recipe List" description="Engineered recipes with cost analysis">
      <div className="space-y-4">
        {loading ? <LoadingSpinner variant="page" /> : recipes.length === 0 ? <Card><CardContent className="p-8 text-center text-slate-400">{"No "}recipes found</CardContent></Card> : recipes.map((recipe) => (
