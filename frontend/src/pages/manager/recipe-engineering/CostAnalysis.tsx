  ...
  return (
    <PageContainer title="Cost Analysis" description="Recipe profitability insights">
      <div className="space-y-4">
        {loading ? <LoadingSpinner variant="page" /> : analysis.length === 0 ? <Card><CardContent className="p-8 text-center text-slate-400">{"No "}cost analysis available</CardContent></Card> : analysis.map((item) => (
