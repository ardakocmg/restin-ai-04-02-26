  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <Card className="bg-background border-border shadow-xl border-b-2" style={{ borderBottomColor: '#2563eb' }}> /* keep-inline */ /* keep-inline */
        ...
        <Card className="bg-background border-border shadow-xl border-b-2" style={{ borderBottomColor: '#ef4444' }}> /* keep-inline */ /* keep-inline */
          <CardContent className="p-4">
        ...
        <Card className="bg-background border-border shadow-xl border-b-2" style={{ borderBottomColor: '#3b82f6' }}> /* keep-inline */ /* keep-inline */
          <CardContent className="p-4">
        ...
        <Card className="bg-background border-border shadow-xl border-b-2" style={{ borderBottomColor: '#10b981' }}> /* keep-inline */ /* keep-inline */
          <CardContent className="p-4">
