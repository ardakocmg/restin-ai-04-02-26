...
export default function POSSettings() {
  ...
  const tabTriggerClass = "data-[state=active]:bg-transparent data-[state=active]:text-white data-[state=active]:border-b-2 data-[state=active]:border-red-500 rounded-none h-10 px-4 text-zinc-500 text-xs font-semibold whitespace-nowrap";
  const cardClass = "border-white/5 bg-zinc-900/50 backdrop-blur-xl";
  const labelClass = "text-xs uppercase text-zinc-500 font-bold";
  const inputClass = "bg-zinc-950 border-white/10";
    ...
    <PermissionGate requiredRole="MANAGER">
      <PageContainer
        ...
        actions={
          <div className="flex gap-2">
            ...
            <Button onClick={handleSaveAll} size="sm" className="bg-red-600 hover:bg-red-700 text-white">
      ...
      >
        <Tabs defaultValue="venue" className="w-full">
          ...
          <div className="mb-6 border-b border-white/5 overflow-x-auto">
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />New Zone</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
                  columns={[
                    ...
                    { key: 'type', label: 'Type', render: row => <Badge variant="outline" className="border-zinc-700">{row.type}</Badge> },
                  ]}
                  data={zones}
                  loading={loading}
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />Add Table</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />Register Device</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />New Group</Button>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                {modifierGroups.map(group => (
                  <div key={group.id} className="p-4 bg-zinc-950 rounded-lg border border-white/5">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs text-zinc-500">min:{group.min} max:{group.max}</span>
                      </div>
                      <div className="flex gap-2">
                        <Button variant="ghost" size="sm" className="h-7 w-7 p-0"><Edit2 className="w-3 h-3 text-zinc-400" /></Button>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {group.modifiers.map((mod, idx) => (
                        <Badge key={idx} variant="outline" className="border-zinc-700 text-zinc-300 text-xs">{mod}</Badge>
                      ))}
                    </div>
                  </div>
                ))}
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" size="sm" className="border-white/10 text-zinc-400">Auto-Discover</Button>
                    <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />Add Printer</Button>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
                  columns={[
                    ...
                    { key: 'station', label: 'Station', render: row => <Badge variant="outline" className="border-zinc-700">{row.station}</Badge> },
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />Add Reason</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
                  columns={[
                    ...
                    { key: 'code', label: 'Code', render: row => <Badge variant="outline" className="border-zinc-700 font-mono">{row.code}</Badge> },
                    {
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />New Discount</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
                  columns={[
                    ...
                    { key: 'appliesTo', label: 'Applies To', render: row => <Badge variant="outline" className="border-zinc-700">{row.appliesTo}</Badge> },
                    {
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />Add Charge</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />Add Tax Rate</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />New Schedule</Button>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                {timedMenus.map(menu => (
                  <div key={menu.id} className="p-4 bg-zinc-950 rounded-lg border border-white/5">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <h4 className="text-sm font-bold text-white">{menu.name}</h4>
                    ...
                    <div className="flex gap-2 mb-2">
                      {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map(day => (
                        <Badge key={day} variant="outline" className={cn(
                          "text-[10px] px-2",
                          menu.days.includes(day) ? "bg-violet-500/10 text-violet-400 border-violet-500/30" : "border-zinc-800 text-zinc-600"
                        )}>{day}</Badge>
                      ))}
                    </div>
                    <div className="flex gap-1 flex-wrap">
                      {menu.categories.map((cat, idx) => (
                        <Badge key={idx} variant="outline" className="border-zinc-700 text-zinc-300 text-[10px]">{cat}</Badge>
                      ))}
                    </div>
                  </div>
                ))}
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />New Rule</Button>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                {happyHours.map(hh => (
                  <div key={hh.id} className="p-4 bg-zinc-950 rounded-lg border border-white/5">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <h4 className="text-sm font-bold text-white">{hh.name}</h4>
                    ...
                    <div className="flex gap-2 mb-2">
                      {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map(day => (
                        <Badge key={day} variant="outline" className={cn(
                          "text-[10px] px-2",
                          hh.days.includes(day) ? "bg-pink-500/10 text-pink-400 border-pink-500/30" : "border-zinc-800 text-zinc-600"
                        )}>{day}</Badge>
                      ))}
                    </div>
                    <div className="flex gap-1 flex-wrap">
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />New Combo</Button>
                </div>
              </CardHeader>
              <CardContent>
                <DataTable
                  columns={[
                    { key: 'name', label: 'Combo Name' },
                    {
                      key: 'items', label: 'Includes', render: row => (
                        <div className="flex gap-1 flex-wrap">
                          {row.items.map((item, idx) => <Badge key={idx} variant="outline" className="border-zinc-700 text-[10px]">{item}</Badge>)}
                        </div>
                      )
                    },
                    { key: 'price', label: 'Price', render: row => <span className="font-bold text-white">€{row.price.toFixed(2)}</span> },
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-zinc-800 text-white"><Plus className="w-4 h-4 mr-2" />Add Role</Button>
                </div>
              </CardHeader>
              <CardContent>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-white/5">
                        <th className="text-left text-xs text-zinc-500 font-bold p-3">Role</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Void</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Discount</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Max %</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Refund</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Reports</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Edit Menu</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Drawer</th>
                        <th className="text-center text-xs text-zinc-500 font-bold p-3">Price Ovrd</th>
                      </tr>
                    </thead>
                    <tbody>
                      {staffPermissions.map(sp => (
                        <tr key={sp.id} className="border-b border-white/5 hover:bg-white/[0.02]">
                          <td className="p-3 text-white font-bold">{sp.role}</td>
                          ...
                          <td className="p-3 text-center"><span className="text-xs text-zinc-400 font-mono">{sp.maxDiscount}%</span></td>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-zinc-950 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" className="border-white/10 text-zinc-400" onClick={() => setAccountingGroups(prev => [...prev, { id: Date.now().toString(), name: '', code: '', type: 'revenue', taxRate: 'Standard VAT', active: true }])}>
                    <Plus className="w-3 h-3 mr-1" /> Add Group
                  </Button>
                </div>
                <p className="text-xs text-zinc-500">Map menu categories to accounting ledger codes for fiscal reporting (Lightspeed parity)</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {accountingGroups.map((g, idx) => (
                    <div key={g.id} className="flex items-center gap-3 p-3 bg-zinc-950 rounded-lg border border-white/5">
                      <div className="flex-1 grid grid-cols-4 gap-3">
                        ...
                        <select className="bg-zinc-950 text-white text-xs border border-white/10 rounded-md px-2" value={g.type} onChange={e => { const u = [...accountingGroups]; u[idx].type = e.target.value; setAccountingGroups(u); }}>
                      ...
                      <button className="text-zinc-600 hover:text-red-400" onClick={() => setAccountingGroups(prev => prev.filter(x => x.id !== g.id))}>
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" className="border-white/10 text-zinc-400" onClick={() => setProductionInstructions(prev => [...prev, { id: Date.now().toString(), name: '', text: '', color: '#888', active: true, appliesTo: 'All' }])}>
                    <Plus className="w-3 h-3 mr-1" /> Add Instruction
                  </Button>
                </div>
                <p className="text-xs text-zinc-500">Quick production notes that print on KDS/kitchen tickets (Lightspeed parity)</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {productionInstructions.map((pi, idx) => (
                    <div key={pi.id} className="flex items-center gap-3 p-3 bg-zinc-950 rounded-lg border border-white/5">
                      ...
                      <div className="flex-1 grid grid-cols-3 gap-3">
                        ...
                        <select className="bg-zinc-950 text-white text-xs border border-white/10 rounded-md px-2" value={pi.appliesTo} onChange={e => { const u = [...productionInstructions]; u[idx].appliesTo = e.target.value; setProductionInstructions(u); }}>
                      ...
                      <button className="text-zinc-600 hover:text-red-400" onClick={() => setProductionInstructions(prev => prev.filter(x => x.id !== pi.id))}>
                        <Trash2 className="w-4 h-4" />
                      </button>
                    </div>
                  ))}
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" className="border-white/10 text-zinc-400" onClick={() => setPriceLists(prev => [...prev, { id: Date.now().toString(), name: '', description: '', isDefault: false, active: true, markup: 0 }])}>
                    <Plus className="w-3 h-3 mr-1" /> Add Price List
                  </Button>
                </div>
                <p className="text-xs text-zinc-500">Multiple price tiers for dine-in, takeaway, delivery, happy hour (Lightspeed parity)</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {priceLists.map((pl, idx) => (
                    <div key={pl.id} className="flex items-center gap-3 p-3 bg-zinc-950 rounded-lg border border-white/5">
                      <div className="flex-1 grid grid-cols-3 gap-3">
                      ...
                      <button className="text-zinc-600 hover:text-red-400" onClick={() => setPriceLists(prev => prev.filter(x => x.id !== pl.id))} disabled={pl.isDefault}>
                        <Trash2 className="w-4 h-4" />
                      </button>
                    </div>
                  ))}
            ...
            <Card className={cardClass}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" className="border-white/10 text-zinc-400" onClick={() => setPaymentTypes(prev => [...prev, { id: Date.now().toString(), name: '', code: '', active: true, requiresReference: false, accountingGroup: '', opensCashDrawer: false }])}>
                    <Plus className="w-3 h-3 mr-1" /> Add Payment Type
                  </Button>
                </div>
                <p className="text-xs text-zinc-500">Configure accepted payment methods and their accounting mapping (Lightspeed parity)</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {paymentTypes.map((pt, idx) => (
                    <div key={pt.id} className="flex items-center gap-3 p-3 bg-zinc-950 rounded-lg border border-white/5">
                      <div className="flex-1 grid grid-cols-4 gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <label htmlFor={`ref-${pt.id}`} className="text-xs text-zinc-400">Requires Ref</label>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-zinc-400">Drawer</span>
                      </div>
                      <Switch checked={pt.active} onCheckedChange={v => { const u = [...paymentTypes]; u[idx].active = v; setPaymentTypes(u); }} />
                      <button className="text-zinc-600 hover:text-red-400" onClick={() => setPaymentTypes(prev => prev.filter(x => x.id !== pt.id))}>
                        <Trash2 className="w-4 h-4" />
                      </button>
                    </div>
                  ))}
          ...
          <TabsContent value="emailnotifications" className="space-y-6">
            <Card className={cardClass}>
              <CardHeader>
                ...
                <p className="text-xs text-zinc-500">SMTP settings for transactional emails (order confirmations, receipts)</p>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
            ...
            <Card className={cardClass}>
              <CardHeader>
                ...
                <p className="text-xs text-zinc-500">Choose what events trigger notifications and on which channels</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
            ...
            <Card className={cardClass}>
              <CardHeader>
                ...
                <p className="text-xs text-zinc-500">Optional SMS notifications for reservations and marketing</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  ...
                  {emailConfig.enableSMS && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                      <div className="space-y-2">
                        ...
                        <select className="w-full bg-zinc-900 text-white text-xs border border-white/10 rounded-md px-3 py-2" value={emailConfig.smsProvider} onChange={e => setEmailConfig({ ...emailConfig, smsProvider: e.target.value })}>
            ...
            <Card className={cardClass}>
              <CardHeader>
                ...
                <p className="text-xs text-zinc-500">Configure which channels each event uses</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {emailConfig.pushCategories?.map((cat, idx) => (
                    <div key={cat.id} className="flex items-center gap-3 p-3 bg-zinc-950 rounded-lg border border-white/5">
                      ...
                      <div className="flex gap-2">
                        {['email', 'push', 'sms'].map(ch => (
                          <button
                            key={ch}
                            className={`text-[10px] px-2 py-0.5 rounded-full font-bold ${cat.channels.includes(ch) ? 'bg-emerald-500/20 text-emerald-400' : 'bg-zinc-800 text-zinc-600'}`}
                            onClick={() => {
                              const u = { ...emailConfig, pushCategories: [...emailConfig.pushCategories] };
          ...
          <TabsContent value="invoice" className="space-y-6">
            <Card className={cardClass}>
              <CardHeader>
                ...
                <p className="text-xs text-zinc-500">Legal entity information printed on invoices and fiscal documents</p>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-zinc-900 text-white text-xs border border-white/10 rounded-md px-3 py-2" value={invoiceConfig.invoiceFormat} onChange={e => setInvoiceConfig({ ...invoiceConfig, invoiceFormat: e.target.value })}>
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-zinc-900 text-white text-xs border border-white/10 rounded-md px-3 py-2" value={invoiceConfig.language} onChange={e => setInvoiceConfig({ ...invoiceConfig, language: e.target.value })}>
            ...
            <Card className={cardClass}>
              <CardHeader>
                ...
                <p className="text-xs text-zinc-500">Configure fiscal printing device for EXO/government reporting</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
