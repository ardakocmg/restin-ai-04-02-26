        ...
        <Card className="lg:col-span-2" data-testid="content-studio-diff">
          ...
          <CardContent className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
              ...
              <pre className="text-xs p-3 rounded-lg overflow-auto max-h-[360px]" style={{ backgroundColor: '#111114', color: '#E2E8F0'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid="content-studio-diff-approved">
                {approvedJson || 'No approved version yet.'}
              </pre>
            </div>
            <div>
              <div className="text-xs text-muted-foreground mb-2">Selected Version</div>
              <pre className="text-xs p-3 rounded-lg overflow-auto max-h-[360px]" style={{ backgroundColor: '#111114', color: '#E2E8F0'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ data-testid="content-studio-diff-selected">
