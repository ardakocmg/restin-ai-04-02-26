                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-6">
                    <div className="p-2 rounded-lg bg-zinc-900/50 border border-white/5 text-center">
                      ...
                      <p className="text-sm font-black text-white">{guest.visit_count || guest.visit_summary?.total_visits || 0}</p>
                    </div>
                    <div className="p-2 rounded-lg bg-zinc-900/50 border border-white/5 text-center">
                      <p className="text-[8px] font-black text-zinc-500 uppercase">Risk</p>
