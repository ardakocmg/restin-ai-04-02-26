      ...
      <Card className="mt-6">
        <Tabs defaultValue="open" className="w-full">
          <CardHeader className="pb-3">
            <TabsList className="grid w-full max-w-md grid-cols-2 bg-zinc-900 border border-white/5 p-1">
              <TabsTrigger value="open" className="font-bold data-[state=active]:bg-red-600 data-[state=active]:text-white">Open Orders</TabsTrigger>
              <TabsTrigger value="closed" className="font-bold data-[state=active]:bg-red-600 data-[state=active]:text-white">Closed Checks</TabsTrigger>
            </TabsList>
          </CardHeader>
