      ...
      actions={
        <div className="flex flex-wrap gap-2" data-testid="error-inbox-filters">
          <Button
            ...
            className={retryableOnly ? 'bg-red-500 text-white font-bold' : 'bg-zinc-900 border-white/10 text-zinc-300 hover:bg-zinc-800'}
          >
            Retryable
          </Button>
          <Button
            ...
            className={blockingOnly ? 'bg-red-500 text-white font-bold' : 'bg-zinc-900 border-white/10 text-zinc-300 hover:bg-zinc-800'}
          >
            Blocking
          </Button>
          <Button
          ...
          <DialogContent className="max-w-4xl">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <Card>
                  <CardContent className="p-4 space-y-1" data-testid="error-inbox-detail-meta">
                    ...
                    <div className="text-sm font-semibold" style={{ color: getSeverityColor(selectedError.severity) }}>{selectedError.severity}</div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4 space-y-1">
                    <div className="text-xs text-zinc-400">Domain</div>
                    <div className="text-sm font-semibold text-zinc-200">{selectedError.domain}</div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4 space-y-1">
                    <div className="text-xs text-zinc-400">Occurrences</div>
                    <div className="text-sm font-semibold text-zinc-200">{selectedError.occurrence_count}</div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="bg-zinc-950 border-white/5">
                <CardHeader>
                  <CardTitle className="text-base text-zinc-100 font-bold uppercase tracking-widest">Source</CardTitle>
                </CardHeader>
                <CardContent>
                  <pre className="text-xs p-3 rounded-lg bg-black text-zinc-300 overflow-auto max-h-[200px]" data-testid="error-inbox-source">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {selectedError.retry_plan.editable_fields.map((field) => (
                          <div key={field.path} className="space-y-1">
                            <label className="text-xs text-zinc-400">{field.label || field.path}</label>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="bg-zinc-900 border-white/10 text-zinc-100 font-bold hover:bg-zinc-800 transition-all shadow-lg"
                >
                ...
                {selectedError.retry_plan?.allowed && (
                  <Button
                    ...
                    className="bg-red-600 text-white font-bold hover:bg-red-500 transition-all shadow-lg shadow-red-500/10"
                  >
