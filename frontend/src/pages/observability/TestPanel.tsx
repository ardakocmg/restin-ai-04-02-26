                  ...
                  <TabsContent value="trace">
                    <div className="space-y-2" data-testid="testpanel-trace-summary">
                      <div className="flex justify-between">
                        <span style={{ color: '#A1A1AA' }}>Status Code:</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <span style={{ color: '#F5F5F7' }}>{activeRun.status_code}</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                      </div>
                      <div className="flex justify-between">
                        <span style={{ color: '#A1A1AA' }}>Latency:</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <span style={{ color: '#F5F5F7' }}>{activeRun.trace?.latency_ms || '--'} ms</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                      </div>
                      <div className="flex justify-between">
                        <span style={{ color: '#A1A1AA' }}>Request ID:</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <span style={{ color: '#F5F5F7' }}>{activeRun.trace?.request_id || '-'}</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                      </div>
                      <div className="flex justify-between">
                        <span style={{ color: '#A1A1AA' }}>Created:</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <span style={{ color: '#F5F5F7' }}>{new Date(activeRun.created_at).toLocaleString()}</span> /* keep-inline */ /* keep-inline */ /* keep-inline */
                      </div>
                    </div>
                  </TabsContent>
