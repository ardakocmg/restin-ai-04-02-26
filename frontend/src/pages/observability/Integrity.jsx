    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <div>
              <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Total Runs</p>
              <p className="text-2xl font-black text-zinc-100">{runs.length}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div>
              <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Last Run</p>
