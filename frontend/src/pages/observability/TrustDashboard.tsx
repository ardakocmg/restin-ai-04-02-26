...
import { Activity, AlertTriangle, CheckCircle2, Shield, XCircle } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-black text-foreground">{openFindings}</p>
                  </div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Kill Switches</p>
                    <p className="text-2xl font-black text-foreground">{killSwitches.length}</p>
                  </div>
