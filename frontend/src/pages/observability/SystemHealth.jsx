...
export default function SystemHealth() {
  ...
  return (
    ...
    >
      {health && (
        <>
          <div className="mb-6 bg-zinc-900/40 p-6 rounded-xl border border-white/5 backdrop-blur-sm">
            <div className="flex items-center gap-4">
              <span className="text-xl font-bold text-zinc-400 uppercase tracking-tighter">Overall Status</span>
              {getOverallBadge(health.overall)}
            </div>
            <p className="text-xs text-zinc-500 mt-2 font-medium uppercase tracking-widest italic">
