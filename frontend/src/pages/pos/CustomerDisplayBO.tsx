            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                <div>
                    ...
                    <div className="pos-card">
                        <h3 className="pos-card-title pos-flex pos-flex--center pos-gap-6"><Monitor size={16} style={{ color: '#3B82F6' }} /> General</h3> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    ...
                    <div className="pos-card">
                        ...
                        {config.showTipPrompt && <div className="pos-form-group" style={{ marginTop: 8 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    ...
                    {/* Idle Screen */}
                    <div className="pos-card">
                        <h3 className="pos-card-title pos-flex pos-flex--center pos-gap-6"><Image size={16} style={{ color: '#10B981' }} /> Idle Screen</h3> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        ...
                        {config.idleSlideshow && <div className="pos-form-group" style={{ marginTop: 8 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                ...
                <div>
                    {/* Appearance */}
                    <div className="pos-card">
                        <h3 className="pos-card-title pos-flex pos-flex--center pos-gap-6"><Palette size={16} style={{ color: '#8B5CF6' }} /> Appearance</h3> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <div className="pos-form-group" style={{ marginBottom: 14 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            ...
                            <div className="pos-flex pos-gap-6">
                                {(['dark', 'light', 'branded'] as const).map(t => (
                                    <button key={t} onClick={() => upd('theme', t)} className={`pos-btn-outline ${config.theme === t ? 'pos-toggle-btn--active' : ''}`} style={{ padding: '8px 16px', fontSize: 12, textTransform: 'capitalize' }}>{t}</button> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                ))}
                            </div>
                        </div>
                        <div className="pos-form-group" style={{ marginBottom: 14 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            ...
                            <div className="pos-flex pos-gap-6">
                                {['#3B82F6', '#10B981', '#F59E0B', '#EF4444', '#8B5CF6', '#EC4899'].map(c => (
                                    <div key={c} onClick={() => upd('accentColor', c)} style={{ width: 28, height: 28, borderRadius: 6, background: c, cursor: 'pointer', border: config.accentColor === c ? '3px solid #fff' : '3px solid transparent' }} /> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                ))}
                            </div>
                        </div>
                        <div className="pos-form-group">
                            ...
                            <div className="pos-flex pos-gap-6">
                                {(['small', 'medium', 'large'] as const).map(s => (
                                    <button key={s} onClick={() => upd('fontSize', s)} className={`pos-btn-outline ${config.fontSize === s ? 'pos-toggle-btn--active' : ''}`} style={{ padding: '8px 16px', fontSize: 12, textTransform: 'capitalize' }}>{s}</button> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                ))}
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Messages */}
                    <div className="pos-card">
                        <h3 className="pos-card-title pos-flex pos-flex--center pos-gap-6"><Type size={16} style={{ color: '#F59E0B' }} /> Messages</h3> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <div className="pos-form-group" style={{ marginBottom: 14 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    ...
                    {/* Preview */}
                    <div className="pos-card" style={{ background: '#000', border: '2px solid #27272a', overflow: 'hidden' }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <div style={{ padding: 20, textAlign: 'center', minHeight: 200, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 12 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            <div className="pos-text-xs pos-text-secondary" style={{ textTransform: 'uppercase', letterSpacing: 1 }}>Live Preview</div> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            <div style={{ fontSize: 16, fontWeight: 600, color: config.accentColor }}>{config.welcomeMessage}</div> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            <div style={{ width: '80%', borderTop: '1px solid rgba(255,255,255,0.1)', margin: '8px 0' }} /> /* keep-inline */ /* keep-inline */ /* keep-inline */
                            <div className="pos-text-sm pos-text-secondary">Order items will appear here...</div>
                            <div style={{ fontSize: 24, fontWeight: 700, color: '#fff', marginTop: 8 }}>€0.00</div> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        </div>
                    </div>
                </div>
            </div>
