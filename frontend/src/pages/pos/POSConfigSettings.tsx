            ...
            <div className="pos-container pos-container--sidebar">
                ...
                <div className="pos-sidebar">
                    ...
                    <div className="pos-card" style={{ padding: 12, marginTop: 12 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        ...
                        <button className="pos-btn pos-btn--outline" style={{ width: '100%', fontSize: 12, padding: '8px 12px', marginBottom: 6 }}><Link size={12} /> View Linked Devices</button> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <button className="pos-btn pos-btn--outline" style={{ width: '100%', fontSize: 12, padding: '8px 12px', marginBottom: 6 }}><Copy size={12} /> Duplicate Config</button> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    </div>
                </div>
                ...
                <div className="pos-main">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <h1 style={{ fontSize: 22, fontWeight: 700 }}>{TABS.find(t => t.key === activeTab)?.label}</h1> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    ...
                    {activeTab === 'scheduling' && (
                        <>
                            <div className="pos-card">
                                ...
                                {config.timedEvents.map((event, idx) => (
                                    <div key={idx} className="pos-card" style={{ background: 'var(--bg-secondary, #09090b)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                        <div>
                                            <div style={{ fontWeight: 600 }}>{event.title}</div> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                        ...
                                        <button className="pos-btn pos-btn--outline" style={{ padding: '6px 10px' }} onClick={() => setConfig(p => ({ ...p, timedEvents: p.timedEvents.filter((_, i) => i !== idx) }))}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                            <Trash2 size={14} />
                                        </button>
                                    </div>
                                ))}
                                <button className="pos-btn pos-btn--outline" style={{ fontSize: 13 }} onClick={() => { /* keep-inline */ /* keep-inline */ /* keep-inline */
                                    setConfig(p => ({
                                        ...p,
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 12 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                    {config.reportTags.map((tag, idx) => (
                                        <span key={idx} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', background: 'rgba(59,130,246,0.1)', border: '1px solid rgba(59,130,246,0.2)', borderRadius: 6, fontSize: 13, color: '#3B82F6' }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                            {tag}
                                            <button style={{ background: 'none', border: 'none', color: '#3B82F6', cursor: 'pointer', padding: 0 }} onClick={() => setConfig(p => ({ ...p, reportTags: p.reportTags.filter((_, i) => i !== idx) }))}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                                <X size={12} />
                                            </button>
                                        </span>
                                    ))}
                            ...
                            <div className="pos-card">
                                ...
                                <button className="pos-btn pos-btn--outline" style={{ fontSize: 13 }} onClick={() => setConfig(p => ({ ...p, stockTransfers: [...p.stockTransfers, { from: 'Main Stock', to: 'Bar Stock' }] }))}> /* keep-inline */ /* keep-inline */ /* keep-inline */
