                ...
                {wizardStep === null ? (
                    ...
                    <>
                        ...
                        <div style={cardStyle}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                <div style={{ padding: '12px 16px', background: 'var(--bg-secondary, #09090b)', borderRadius: 8  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                    <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginBottom: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>IP Address</div>
                                    <div style={{ fontSize: 16, fontWeight: 600  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{hubIP}</div>
                                </div>
                                <div style={{ padding: '12px 16px', background: 'var(--bg-secondary, #09090b)', borderRadius: 8  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                    <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginBottom: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Connection Code</div>
                                    <div style={{ fontSize: 16, fontWeight: 600  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{connectionCode}</div>
                                </div>
                                <div style={{ padding: '12px 16px', background: 'var(--bg-secondary, #09090b)', borderRadius: 8  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                    <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginBottom: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Current Version</div>
                                    <div style={{ fontSize: 16, fontWeight: 600  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{hubVersion}</div>
                                </div>
                                <div style={{ padding: '12px 16px', background: 'var(--bg-secondary, #09090b)', borderRadius: 8  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                    <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginBottom: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Connected Devices</div>
                                    <div style={{ fontSize: 16, fontWeight: 600  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{stations.length}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                            <h2 style={{ fontSize: 16, fontWeight: 600  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Stations ({stations.length})</h2>
                        ...
                        {stations.map(station => (
                            <div key={station.id} style={{ ...cardStyle, display: 'flex', alignItems: 'center', justifyContent: 'space-between'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                <div>
                                    <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{station.name}</div>
                                    <div style={{ fontSize: 13, color: 'var(--text-secondary, #a1a1aa)'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Items: {station.itemRouting}</div>
                                </div>
                    ...
                    <>
                        ...
                        {wizardStep === 1 && (
                            <div style={cardStyle}>
                                <h3 style={{ fontSize: 16, fontWeight: 600, marginBottom: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Station Name</h3>
                        ...
                        {wizardStep === 2 && (
                            <div style={cardStyle}>
                                <h3 style={{ fontSize: 16, fontWeight: 600, marginBottom: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Item Routing</h3>
                                <p style={{ fontSize: 13, color: 'var(--text-secondary, #a1a1aa)', marginBottom: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                        ...
                        {wizardStep === 3 && (
                            <div style={cardStyle}>
                                <h3 style={{ fontSize: 16, fontWeight: 600, marginBottom: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Ticket Display</h3>
                                ...
                                {Object.entries(newTicketDisplay).map(([key, value]) => (
                                    <div key={key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 0', borderBottom: '1px solid rgba(255,255,255,0.04)'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                        <span style={{ fontSize: 14  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{key.replace(/([A-Z])/g, ' $1').replace(/^./, s => s.toUpperCase())}</span>
                        ...
                        {wizardStep === 4 && (
                            <div style={cardStyle}>
                                <h3 style={{ fontSize: 16, fontWeight: 600, marginBottom: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Order Status Setup</h3>
                                <p style={{ fontSize: 13, color: 'var(--text-secondary, #a1a1aa)', marginBottom: 16  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                ...
                                <div style={{ ...cardStyle, background: 'var(--bg-secondary, #09090b)', display: 'flex', alignItems: 'center', justifyContent: 'space-between'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                    <div>
                                        ...
                                        <div style={{ fontSize: 13, color: 'var(--text-secondary, #a1a1aa)'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Received order awaiting preparation</div>
                                    </div>
                                    <button
                                ...
                                <div style={{ ...cardStyle, background: 'var(--bg-secondary, #09090b)', display: 'flex', alignItems: 'center', justifyContent: 'space-between'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                    <div>
                                        ...
                                        <div style={{ fontSize: 13, color: 'var(--text-secondary, #a1a1aa)'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Cooked items ready to be served</div>
                                    </div>
                                    <button
                                ...
                                <div style={{ display: 'flex', gap: 12, marginTop: 20  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                                    ...
                                    <button onClick={saveStation} style={btnPrimary}>
                                        <Check size={14} style={{ marginRight: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ /> {editStationId ? 'Save Changes' : 'Create Station'}
                                    </button>
                                </div>
                            </div>
                        )}
