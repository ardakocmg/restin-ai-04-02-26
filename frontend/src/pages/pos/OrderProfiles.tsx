            ...
            {editing && <div className="pos-modal-overlay" onClick={() => setEditing(null)}>
                <div className="pos-card pos-modal max-h-[85vh] overflow-auto" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="pos-form-grid grid-cols-[1fr_auto]">
                        ...
                        <div><label className="pos-form-label">Sort Order</label><input type="number" min={0} className="pos-input w-20 text-center" value={editing.sortOrder} onChange={e => setEditing(p => p ? { ...p, sortOrder: parseInt(e.target.value) || 0 } : null)} aria-label="Sort order" /></div>
                    </div>
