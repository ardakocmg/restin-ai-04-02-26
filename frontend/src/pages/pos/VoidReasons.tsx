...
const VoidReasons: React.FC = () => {
    ...
    const categoryBadge = (cat: string) => {
        ...
        return <span className={`pos-badge ${cls}`} style={{ textTransform: 'capitalize' }}>{cat}</span>; /* keep-inline */ /* keep-inline */ /* keep-inline */
    };
    ...
    return (
        <div className="pos-page"><div className="pos-container">
            ...
            <div className="pos-card">
                ...
                {filtered.map(r => (
                    <div key={r.id} className="pos-table-row" style={{ gridTemplateColumns: voidTableCols, opacity: r.isActive ? 1 : 0.5 }} onClick={() => setEditing({ ...r })}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        ...
                        <div className="pos-flex pos-gap-4">
                            {r.requiresManager && <span className="pos-badge pos-badge--red" style={{ fontSize: 9 }}>Mgr</span>} /* keep-inline */ /* keep-inline */ /* keep-inline */
                            {r.requiresNote && <span className="pos-badge pos-badge--amber" style={{ fontSize: 9 }}>Note</span>} /* keep-inline */ /* keep-inline */ /* keep-inline */
            ...
            {editing && <div className="pos-modal-overlay" onClick={() => setEditing(null)}>
                <div className="pos-card pos-modal pos-modal--sm" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="pos-modal-footer">
                        ...
                        <button title="Delete reason" className="pos-btn-outline" style={{ color: '#EF4444' }} onClick={() => { setReasons(p => p.filter(r => r.id !== editing.id)); setEditing(null); toast.success('Deleted'); }}><Trash2 size={14} /></button> /* keep-inline */ /* keep-inline */ /* keep-inline */
