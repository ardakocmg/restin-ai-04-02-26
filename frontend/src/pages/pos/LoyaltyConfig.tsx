            ...
            {tab === 'settings' && <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                <div className="pos-card">
                    ...
                    <SettingRow label="Points Per Euro" desc="Points earned per €1 spent">
                        <input type="number" min={1} className="pos-input" style={{ width: 80, textAlign: 'center' }} value={config.pointsPerEuro} onChange={e => upd('pointsPerEuro', parseInt(e.target.value) || 1)} /></SettingRow> /* keep-inline */ /* keep-inline */ /* keep-inline */
                ...
                <div className="pos-card">
                    ...
                    <SettingRow label="Min Points to Redeem" desc="Minimum points before redemption">
                        <input type="number" min={1} className="pos-input" style={{ width: 80, textAlign: 'center' }} value={config.redeemThreshold} onChange={e => upd('redeemThreshold', parseInt(e.target.value) || 1)} /></SettingRow> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    <SettingRow label="Redemption Value (€)" desc="Euro value per redemption unit">
                        <input type="number" min={1} className="pos-input" style={{ width: 80, textAlign: 'center' }} value={config.redeemValue} onChange={e => upd('redeemValue', parseInt(e.target.value) || 1)} /></SettingRow> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    <SettingRow label="Points Expiry (Days)" desc="Days before points expire">
                        <input type="number" min={0} className="pos-input" style={{ width: 80, textAlign: 'center' }} value={config.expiryDays} onChange={e => upd('expiryDays', parseInt(e.target.value) || 0)} /></SettingRow> /* keep-inline */ /* keep-inline */ /* keep-inline */
                    <SettingRow label="Referral Bonus" desc="Points for successful referral">
                        <input type="number" min={0} className="pos-input" style={{ width: 80, textAlign: 'center' }} value={config.referralBonus} onChange={e => upd('referralBonus', parseInt(e.target.value) || 0)} /></SettingRow> /* keep-inline */ /* keep-inline */ /* keep-inline */
                </div>
                <div className="pos-card">
