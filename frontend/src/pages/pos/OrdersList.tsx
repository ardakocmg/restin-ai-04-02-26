...
export default function OrdersList({ venueId, onReopen, onClose }: OrdersListProps) {
    ...
    return (
        <div style={s.overlay} onClick={onClose}>
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }} onClick={e => e.stopPropagation()}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                <div style={s.header}>
                    <span style={s.title}>Orders</span>
                    <div style={s.headerRight}>
                        <button
                            style={{ ...s.filterBtn, backgroundColor: '#2A9D8F', color: '#fff', border: 'none' }} /* keep-inline */ /* keep-inline */ /* keep-inline */
                ...
                <div style={s.filterBar}>
                    ...
                    <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6, backgroundColor: '#1a1a1a', borderRadius: 8, padding: '4px 10px', border: '1px solid #333' }}> /* keep-inline */ /* keep-inline */ /* keep-inline */
                        <Search size={14} color="#666" />
                        <input aria-label="Input"
                            style={{ background: 'none', border: 'none', outline: 'none', color: '#fff', fontSize: 12, width: 140 }} /* keep-inline */ /* keep-inline */ /* keep-inline */
                                ...
                                {filtered.map((o: OrderEntry, idx: number) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td style={{ ...s.td, fontWeight: 700 }}>€{(o.total || 0).toFixed(2)}</td> /* keep-inline */ /* keep-inline */ /* keep-inline */
                                            <td style={s.td}>
                                                <span style={{ /* keep-inline */ /* keep-inline */ /* keep-inline */
                                                    ...s.statusBadge,
                                            ...
                                            <td style={s.td}>
                                                {o.status === 'finalized' && (
                                                    <>
                                                        ...
                                                        <button style={{ ...s.actionBtn, color: '#F4A261', borderColor: '#F4A261' }} onClick={() => { toast.info('Partial refund — select items to refund'); handleReopen(o); }} title="Partial Refund"> /* keep-inline */ /* keep-inline */ /* keep-inline */
