...
export default function OrdersList({ venueId, onReopen, onClose }: OrdersListProps) {
    ...
    return (
        <div style={s.overlay} onClick={onClose}>
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ onClick={e => e.stopPropagation()}>
                <div style={s.header}>
                                ...
                                {filtered.map((o: OrderEntry, idx: number) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td style={{ ...s.td, fontWeight: 700  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>€{(o.total || 0).toFixed(2)}</td>
                                            <td style={s.td}>
                                            ...
                                            <td style={s.td}>
                                                {o.status === 'finalized' && (
                                                    <>
                                                        ...
                                                        <button style={{ ...s.actionBtn, color: '#F4A261', borderColor: '#F4A261'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ onClick={() => { toast.info('Partial refund — select items to refund'); handleReopen(o); }} title="Partial Refund">
