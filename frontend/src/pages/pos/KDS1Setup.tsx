    ...
    return (
        <div style={pageStyle}>
            <div style={containerStyle}>
                ...
                <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 24  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>KDS 1.0 Setup</h1>
                        ...
                        <div style={{ display: 'flex', gap: 6  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                            {config.connectionCode.split('').map((digit, idx) => (
                                <div key={idx} style={{ /* keep-inline */
                                 ...
                                 /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{digit}</div>
                            ))}
                        </div>
                        <button style={{ ...btnOutline, padding: '8px 14px'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */ onClick={() => {
                ...
                <div style={cardStyle}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                        ...
                        >
                            ...
                            <div style={{ fontWeight: 600, marginBottom: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Receipt Mode</div>
                        ...
                        >
                            ...
                            <div style={{ fontWeight: 600, marginBottom: 4  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Production Mode</div>
                            <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                ...
                <div style={cardStyle}>
                    ...
                    <div style={{ marginBottom: 20  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Accounting Groups</div>
                    ...
                    {/* Order Profiles */}
                    <div style={{ marginBottom: 20  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Order Profiles</div>
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                    ...
                    {/* Production Centers */}
                    <div style={{ marginBottom: 20  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Production Centers</div>
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                    ...
                    {/* Tags */}
                    <div>
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Tags</div>
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                            {ALL_TAGS.map(t => (
                ...
                <div style={cardStyle}>
                    ...
                    <div style={toggleRow}>
                        <div>
                            <div style={{ fontWeight: 500  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Printing Profile</div>
                    ...
                    <div style={toggleRow}>
                        <div>
                            <div style={{ fontWeight: 500  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Print chit when order is ready</div>
                            <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginTop: 2  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                    ...
                    <div style={toggleRow}>
                        <div>
                            <div style={{ fontWeight: 500  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>Print chit when removed from KDS</div>
                            <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginTop: 2  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
