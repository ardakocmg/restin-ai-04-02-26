    ...
    return (
        <div style={pageStyle}>
            <div style={containerStyle}>
                {/* Back */}
                <button onClick={() => navigate('/pos/kds1')} style={{ ...btnOutline, marginBottom: 20 }}> /* keep-inline */ /* keep-inline */
                    <ArrowLeft size={16} /> Back to KDS 1.0
                </button>

                <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 24 }}>KDS 1.0 Setup</h1> /* keep-inline */ /* keep-inline */

                {/* 1. Connection Code */}
                <div style={cardStyle}>
                    <h2 style={{ fontSize: 16, fontWeight: 600, marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}> /* keep-inline */ /* keep-inline */
                    ...
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}> /* keep-inline */ /* keep-inline */
                        <div style={{ display: 'flex', gap: 6 }}> /* keep-inline */ /* keep-inline */
                            {config.connectionCode.split('').map((digit, idx) => (
                                <div key={idx} style={{ /* keep-inline */ /* keep-inline */
                        ...
                        <button style={{ ...btnOutline, padding: '8px 14px' }} onClick={() => { /* keep-inline */ /* keep-inline */
                ...
                <div style={cardStyle}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}> /* keep-inline */ /* keep-inline */
                        ...
                        >
                            <LayoutList size={24} style={{ marginBottom: 8, color: config.mode === 'receipt' ? '#3B82F6' : 'var(--text-secondary)' }} /> /* keep-inline */ /* keep-inline */
                            <div style={{ fontWeight: 600, marginBottom: 4 }}>Receipt Mode</div> /* keep-inline */ /* keep-inline */
                        ...
                        >
                            <Grid size={24} style={{ marginBottom: 8, color: config.mode === 'production' ? '#8b5cf6' : 'var(--text-secondary)' }} /> /* keep-inline */ /* keep-inline */
                            <div style={{ fontWeight: 600, marginBottom: 4 }}>Production Mode</div> /* keep-inline */ /* keep-inline */
                            <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)' }}> /* keep-inline */ /* keep-inline */
                ...
                <div style={cardStyle}>
                    ...
                    {/* Accounting Groups */}
                    <div style={{ marginBottom: 20 }}> /* keep-inline */ /* keep-inline */
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5 }}>Accounting Groups</div> /* keep-inline */ /* keep-inline */
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}> /* keep-inline */ /* keep-inline */
                    ...
                    {/* Order Profiles */}
                    <div style={{ marginBottom: 20 }}> /* keep-inline */ /* keep-inline */
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5 }}>Order Profiles</div> /* keep-inline */ /* keep-inline */
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}> /* keep-inline */ /* keep-inline */
                    ...
                    {/* Production Centers */}
                    <div style={{ marginBottom: 20 }}> /* keep-inline */ /* keep-inline */
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5 }}>Production Centers</div> /* keep-inline */ /* keep-inline */
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}> /* keep-inline */ /* keep-inline */
                    ...
                    {/* Tags */}
                    <div>
                        <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary, #a1a1aa)', textTransform: 'uppercase', letterSpacing: 0.5 }}>Tags</div> /* keep-inline */ /* keep-inline */
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}> /* keep-inline */ /* keep-inline */
                            {ALL_TAGS.map(t => (
                ...
                <div style={cardStyle}>
                    ...
                    <div style={toggleRow}>
                        <div>
                            <div style={{ fontWeight: 500 }}>Printing Profile</div> /* keep-inline */ /* keep-inline */
                            <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginTop: 2 }}> /* keep-inline */ /* keep-inline */
                        ...
                        <select aria-label="Input"
                            ...
                            style={{ padding: '6px 12px', background: 'var(--bg-secondary, #09090b)', border: '1px solid var(--border-primary, #27272a)', borderRadius: 6, color: 'var(--text-primary, #fafafa)', fontSize: 13 }} /* keep-inline */ /* keep-inline */
                    ...
                    <div style={toggleRow}>
                        <div>
                            <div style={{ fontWeight: 500 }}>Print chit when order is ready</div> /* keep-inline */ /* keep-inline */
                            <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginTop: 2 }}> /* keep-inline */ /* keep-inline */
                    ...
                    <div style={toggleRow}>
                        <div>
                            <div style={{ fontWeight: 500 }}>Print chit when removed from KDS</div> /* keep-inline */ /* keep-inline */
                            <div style={{ fontSize: 12, color: 'var(--text-secondary, #a1a1aa)', marginTop: 2 }}> /* keep-inline */ /* keep-inline */
