...
import {
    ...
    BookOpen, Play, BarChart3,
    MessageSquare, Volume2, ChevronRight
} from 'lucide-react';
...
export default function VoiceAI() {
    ...
    // Mock data
    const config = { persona: 'Professional, Friendly Maltese Restaurant Host' };
    const activities = [
    ...
    return (
        <div className="flex flex-col gap-8 p-6">
            {/* Top Banner */}
            <Card className="bg-gradient-to-br from-zinc-900 to-black border-zinc-800 p-8 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <Card className="bg-zinc-900/30 border-zinc-800 p-6">
                        ...
                        <div className="space-y-3">
                            {[
                                { name: 'Dinner Menu 2026.pdf', date: 'Feb 4' },
                                { name: 'Allergen Policy.pdf', date: 'Jan 22' },
                                { name: 'Cancellation Rules.pdf', date: 'Feb 1' },
                            ].map((doc, i) => (
                    ...
                    <Card className="bg-gradient-to-br from-red-600/10 to-transparent border-red-500/10 p-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm font-bold text-white italic">"{config.persona}"</p>
                ...
                <div className="lg:col-span-8">
                    <Card className="bg-zinc-900/10 border-zinc-800 h-full">
                        <CardHeader className="border-b border-zinc-800 bg-zinc-950/20">
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-lg font-black text-white italic flex items-center gap-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button variant="ghost" size="sm" className="text-xs font-bold text-zinc-500">View All</Button>
                                </div>
                            </div>
                        </CardHeader>
