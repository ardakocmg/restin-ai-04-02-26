            ...
            {!isLoading && (
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        <Card className="bg-zinc-900 border-white/10 group hover:border-emerald-500/30 transition-all">
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-zinc-500 mt-1">Based on 4-week moving average</p>
                            </CardContent>
                        </Card>

                        <Card className="bg-zinc-900 border-white/10 group hover:border-blue-500/30 transition-all">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-sm text-zinc-400 flex items-center gap-2">
                        ...
                        <Card className="bg-zinc-900 border-white/10 group hover:border-amber-500/30 transition-all">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-sm text-zinc-400 flex items-center gap-2">
                        ...
                        <Card className="bg-zinc-900 border-white/10 group hover:border-purple-500/30 transition-all">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-sm text-zinc-400 flex items-center gap-2">
