            ...
            <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex items-end justify-between border-b border-white/5 pb-8">
                    <div>
                        <div className="flex items-center gap-4 mb-2">
                            ...
                            <h1 className="text-4xl font-black text-white uppercase tracking-tighter leading-none">Attendance Exceptions</h1>
                        </div>
                        <p className="text-zinc-500 font-bold uppercase tracking-[0.2em] text-[10px] ml-14">Action Required for Discrepancies</p>
                    </div>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between px-2">
                        <h2 className="text-[11px] font-bold text-zinc-500 uppercase tracking-widest">Active Discrepancies ({exceptions.length})</h2>
                                ...
                                <CardContent className="p-0">
                                    <div className="flex items-center justify-between p-6">
                                        <div className="flex items-center gap-6">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-3">
                                                    <h3 className="text-lg font-black text-white uppercase tracking-tighter leading-none">{exc.name}</h3>
                                                    <span className="text-zinc-600 font-bold text-xs">•</span>
                                                    <span className="text-zinc-400 font-bold uppercase text-[10px] tracking-tight">{exc.type}</span>
                                                </div>
                                        ...
                                        <div className="flex items-center gap-6">
                                            ...
                                            <div className="flex gap-2">
                                                <Button variant="ghost" className="bg-zinc-800/50 hover:bg-zinc-800 text-zinc-400 text-[10px] font-bold uppercase px-4 h-10 rounded-xl">
                                                    Ignore
                                                </Button>
                                                <Button size="sm" className="bg-blue-600 hover:bg-blue-500 text-white font-bold uppercase text-[10px] tracking-widest h-10 px-6 rounded-xl flex items-center gap-2">
                                                    Resolve
                                                    <ArrowRight className="w-3 h-3" />
                                                </Button>
                                                <Button variant="outline" size="icon" className="h-10 w-10 border-white/5 bg-zinc-900 hover:bg-zinc-800 rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="bg-zinc-900/20 border-white/5 p-6 space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="p-2 rounded-lg bg-red-500/10 text-red-500">
                                <AlertCircle className="w-4 h-4" />
                            </div>
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-zinc-300">Priority Issues</h4>
                        </div>
                    ...
                    <Card className="bg-zinc-900/20 border-white/5 p-6 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-zinc-300">Recent Resolutions</h4>
                        </div>
                        <p className="text-[9px] font-medium text-zinc-500 uppercase leading-relaxed">
                    ...
                    <Card className="bg-zinc-900/20 border-white/5 p-6 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-zinc-300">Auto-Fix Enabled</h4>
                        </div>
                        <p className="text-[9px] font-medium text-zinc-500 uppercase leading-relaxed">
