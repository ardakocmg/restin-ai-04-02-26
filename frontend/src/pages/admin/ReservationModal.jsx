            ...
            <DialogContent className="max-w-xl bg-zinc-950 border-white/10 text-white">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="space-y-1">
                                ...
                                <Input value={formData.first_name} onChange={e => setFormData({ ...formData, first_name: e.target.value })} className="bg-zinc-900 border-white/5 h-9" />
                            </div>
                            <div className="space-y-1">
                                <Label className="text-[10px] uppercase font-bold text-zinc-500">Last Name</Label>
                                <Input value={formData.last_name} onChange={e => setFormData({ ...formData, last_name: e.target.value })} className="bg-zinc-900 border-white/5 h-9" />
                            </div>
                        </div>
                        <div className="space-y-1">
                            <Label className="text-[10px] uppercase font-bold text-zinc-500">Phone</Label>
                            <Input value={formData.phone} onChange={e => setFormData({ ...formData, phone: e.target.value })} className="bg-zinc-900 border-white/5 h-9" />
                        </div>
                        <div className="space-y-1">
                            <Label className="text-[10px] uppercase font-bold text-zinc-500">Notes</Label>
                            <textarea
                                className="w-full bg-zinc-900 border border-white/5 rounded-md p-2 text-sm focus:outline-none focus:border-red-500/50"
                                rows={3}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="space-y-1">
                                ...
                                <Input type="date" value={formData.date} onChange={e => setFormData({ ...formData, date: e.target.value })} className="bg-zinc-900 border-white/5 h-9" />
                            </div>
                            <div className="space-y-1">
                                <Label className="text-[10px] uppercase font-bold text-zinc-500">Covers</Label>
                                <Input type="number" value={formData.guests} onChange={e => setFormData({ ...formData, guests: e.target.value })} className="bg-zinc-900 border-white/5 h-9" />
                            </div>
                        </div>
                        ...
                        <Button
                            variant="secondary"
                            size="sm"
                            className="w-full bg-zinc-900 border border-white/5 text-[10px] font-black uppercase tracking-widest h-8"
                        ...
                        {slots.length > 0 && (
                            <div className="space-y-2">
                                <Label className="text-[10px] uppercase font-bold text-zinc-500">Select Time</Label>
                ...
                <DialogFooter className="mt-4 gap-2">
                    ...
                    <Button
                        ...
                        className="bg-red-600 hover:bg-red-500 text-white uppercase text-[10px] font-black tracking-widest px-8"
                    >
