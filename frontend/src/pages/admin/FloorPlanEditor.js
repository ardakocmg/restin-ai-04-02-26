...
export default function FloorPlanEditor() {
  ...
  return (
    <div className="h-screen flex flex-col bg-zinc-950">
      ...
      <div className="bg-zinc-900 border-b border-white/10 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-heading font-bold text-white">{plan.name}</h1>
              <p className="text-sm text-zinc-400">{objects.length} objects</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className={`border-white/10 ${snapToGrid ? 'bg-red-500/20' : ''}`}
            >
      ...
      {/* Properties Panel */}
      {selectedObject && (
        <div className="bg-zinc-900 border-t border-white/10 p-4">
          <div className="flex items-center gap-4">
            <div>
            ...
            <div>
              ...
              <Input
                ...
                className="w-20 bg-zinc-800 border-white/10 text-white"
              />
            </div>
            <div>
