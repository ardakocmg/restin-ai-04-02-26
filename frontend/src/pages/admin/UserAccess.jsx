            ...
            >
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="text-sm font-medium text-zinc-400">Active Roles</CardTitle>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="text-sm font-medium text-zinc-400">Employee Record</CardTitle>
                            </CardHeader>
                            <CardContent>
                                {user?.employee_id ? (
                                    ...
                                    <p className="text-xs text-zinc-500">No employee record linked</p>
                                )}
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <div className="lg:col-span-3">
                        <Tabs defaultValue="assignments" className="w-full">
                            <TabsList className="w-full justify-start bg-zinc-900 border border-zinc-800 p-1">
                                <TabsTrigger value="assignments" className="data-[state=active]:bg-zinc-800">Assignments</TabsTrigger>
                                <TabsTrigger value="context" className="data-[state=active]:bg-zinc-800">Active Context</TabsTrigger>
                                <TabsTrigger value="overrides" className="data-[state=active]:bg-zinc-800">Overrides</TabsTrigger>
                                <TabsTrigger value="audit" className="data-[state=active]:bg-zinc-800">Audit Logs</TabsTrigger>
                            </TabsList>
                                        ...
                                        {activeContext ? (
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
                                                    <div className="text-sm text-zinc-500 mb-1">Active Unit</div>
                                                    <div className="font-medium text-white flex items-center gap-2">
                                                        <Globe className="w-4 h-4" /> {activeContext.active_unit_id}
                                                    </div>
                                                </div>
                                                <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
                                                    <div className="text-sm text-zinc-500 mb-1">Active Role</div>
                                                    <div className="font-medium text-white flex items-center gap-2">
                                                        <Shield className="w-4 h-4 text-emerald-400" /> {activeContext.active_role}
                                                    </div>
                                                </div>
                                                <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
                                                    <div className="text-sm text-zinc-500 mb-1">Active Station</div>
                                                    <div className="font-medium text-white flex items-center gap-2">
                                                        <Activity className="w-4 h-4" /> {activeContext.active_station}
                                                    </div>
                                                </div>
                                                <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
                                                    <div className="text-sm text-zinc-500 mb-1">Session Started</div>
