          ...
          <CardContent>
            <div className="space-y-3">
              {stockLevels.length === 0 ? (
                <p className="text-muted-foreground text-center py-8">No stock level alerts</p>
        ...
        <Card>
          ...
          <CardContent>
            {wasteData.length > 0 ? (
              ...
              <p className="text-muted-foreground text-center py-12">No waste data recorded yet</p>
            )}
          </CardContent>
        </Card>
      </div>
