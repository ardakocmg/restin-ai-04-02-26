    ...
    >
      ...
      <div className="p-4 border-b border-white/10">
        <div className="flex items-start justify-between mb-2">
          <div>
            <div className="text-sm text-zinc-500">{item.table_name}</div>
            <div className="text-xs text-zinc-600">{item.ticket_display_id}</div>
          </div>
      ...
      <div className="p-4 bg-zinc-800/50">
        ...
        {item.status === "DONE" && item.actual_prep_seconds && (
          <div className="text-center">
            <div className="text-sm text-zinc-400">Actual Time</div>
