    ...
    return (
      <div className="min-h-screen flex items-center justify-center " style={{ backgroundColor: '#0A0A0B'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
        <div className="text-center\">
          <div className="text-2xl font-bold " style={{ color: '#F5F5F7'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{"Loading "}KDS...</div>
        </div>
      </div>
    );
  }
            ...
            {ticket.order_details && (
              <div className="mb-3 pb-3 " style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.1)'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
                <div className="flex items-center justify-between text-sm\">
                  <span className="font-semibold " style={{ color: '#F5F5F7'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{ticket.order_details.table_name}</span>
                  <span style={{ color: '#A1A1AA'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{ticket.order_details.server_name}</span>
                </div>
            ...
            <div className="space-y-2 mb-4">
              {ticket.order_details?.items?.map((item, idx) => (
                <div key={idx} className="bg-gray-700 rounded-lg p-2">
                  ...
                  {item.notes && (
                    <p className="text-xs mt-1" style={{ color: '#FDB86C'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>{item.notes}</p>
                  )}
