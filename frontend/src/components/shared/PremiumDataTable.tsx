    ...
    return (
        <div className="space-y-4">
            ...
            <div
                ...
                style={{ '--table-height': maxHeight } as React.CSSProperties} /* keep-inline */ /* keep-inline */
            >
                {/* Loading Overlay */}
                {loading && (
                                ...
                                <tr key={headerGroup.id}>
                                    {headerGroup.headers.map((header) => (
                                        <th
                                            ...
                                            style={{ width: header.column.columnDef.size }} /* keep-inline */ /* keep-inline */
                                        >
                                    ...
                                    >
                                        {row.getVisibleCells().map((cell) => (
                                            <td
                                                ...
                                                style={{ width: cell.column.columnDef.size }} /* keep-inline */ /* keep-inline */
                                            >
