  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
      ...
      <div className="relative z-10 w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-2xl card-dark">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-4 rounded-xl border-2 transition-all duration-200 ${
                        isSelected
                          ...
                          : 'bg-zinc-900/50 border-white/10 hover:border-red-500/50'
                      }`}
                      style={
                        isSelected
        ...
        {/* Footer */}
        <div className="sticky bottom-0 z-10 bg-zinc-900 border-t border-white/10 p-6">
          {/* Quantity Selector */}
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-10 h-10 rounded-lg bg-zinc-800 hover:bg-zinc-700 border border-white/10 flex items-center justify-center transition-colors"
                disabled={quantity <= 1}
              >
