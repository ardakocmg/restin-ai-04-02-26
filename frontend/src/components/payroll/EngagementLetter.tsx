        ...
        <div className="flex justify-center mb-12">
            <div className="text-center">
                {displayLogo ? (
                    ...
                    <svg width="400" height="80" viewBox="0 0 400 80" style={{ color: primaryColor  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
            ...
            <div className={pageClass}>
                ...
                <div className="mt-12 space-y-12">
                    <div>
                        ...
                        <div className="mb-2 italic text-2xl" style={{ fontFamily: 'cursive'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>JPortelli</div>
