...
export default function SkillsPassDocument({ data, view = 'certificate' }) {
    ...
    if (view === 'batch') {
        return (
            <div id="skillspass-batch-to-export" className="bg-white text-black p-12 max-w-[210mm] mx-auto text-center" style={{ fontFamily: 'Arial, sans-serif' }}> /* keep-inline */
    ...
    return (
        <div id="skillspass-cert-to-export" className="bg-white text-black p-0 max-w-[210mm] mx-auto relative min-h-[297mm] flex flex-col" style={{ fontFamily: 'Arial, sans-serif' }}> /* keep-inline */
            {/* Top Border */}
                ...
                <div className="text-center w-full space-y-10">
                    ...
                    <div className="flex flex-col items-center pt-8">
                        <div className="mb-2 italic text-3xl font-serif text-foreground tracking-wider">
                            ...
                            <span style={{ fontFamily: 'cursive' }}>{issuerName}</span> /* keep-inline */
                        </div>
