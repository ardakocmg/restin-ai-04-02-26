...
export default function FS3Document({ fs3Data, venue = null }) {
    ...
    return (
        <div id="fs3-to-export" className="fs3-document !bg-white !text-black p-6 max-w-[210mm] mx-auto border border-border shadow-sm" style={{ fontFamily: 'Arial, sans-serif'  /* keep-inline */ }} /* keep-inline */ /* keep-inline */>
