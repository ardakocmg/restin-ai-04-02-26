...
export default function PayslipDocument({ payslipData }) {
    ...
    return (
        <div id="payslip-to-export" className="payslip-document !bg-white !text-black p-10 max-w-[210mm] mx-auto border border-border shadow-sm" style={{ fontFamily: 'Arial, sans-serif' }}> /* keep-inline */
            {/* Header Section */}
                ...
                <div className="flex flex-col items-start">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-2xl font-bold tracking-tighter leading-none" style={{ fontFamily: 'Georgia, serif' }}> /* keep-inline */
                                CAVIAR & BULL
                            </h1>
                            <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-800" style={{ fontFamily: 'Arial, sans-serif' }}> /* keep-inline */
                                MALTA
                            </span>
                        </div>
                    </div>
