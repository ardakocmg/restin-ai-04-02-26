                ...
                <div className="flex flex-col items-start">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-2xl font-bold tracking-tighter leading-none" style={{ fontFamily: 'Georgia, serif' }}>
                                CAVIAR & BULL
                            </h1>
                            <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-800" style={{ fontFamily: 'Arial, sans-serif' }}>
                                MALTA
                            </span>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-4 border-t-2 border-dashed border-gray-200 space-y-4">
                        ...
                        <div className="relative group overflow-hidden">
                            <div className="absolute inset-0 bg-zinc-900 rounded-xl transform transition-transform group-hover:scale-105" />
