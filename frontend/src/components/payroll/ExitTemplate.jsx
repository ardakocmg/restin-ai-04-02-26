        ...
        <div id="exit-to-export" className={pageClass}>
            ...
            <div className="grid grid-cols-2 gap-8 mb-12">
                <div className="space-y-3">
                    <h3 className="text-zinc-400 font-bold uppercase text-[10px] border-b border-zinc-100 pb-1">Personel Details</h3>
                ...
                <div className="space-y-3">
                    <h3 className="text-zinc-400 font-bold uppercase text-[10px] border-b border-zinc-100 pb-1">Exit Information</h3>
            ...
            {/* Settlement Table */}
            <div className="mb-12">
                <h3 className="text-zinc-400 font-bold uppercase text-[10px] mb-4">Final Settlement Summary</h3>
            ...
            <div className="flex justify-between items-end mt-auto pt-12">
                <div className="w-64">
                    ...
                    <div className="text-[10px] text-zinc-400">Employee Signature</div>
                </div>
            ...
            {/* Print Footer */}
            <div className="mt-8 pt-4 border-t border-zinc-100 flex justify-between items-center text-[8px] text-zinc-400 uppercase tracking-widest">
