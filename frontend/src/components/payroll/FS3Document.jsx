...
export default function FS3Document({ fs3Data, venue = null }) {
    ...
    const sectionTitleStyle = "bg-gray-800 text-white px-2 py-0.5 text-[11px] font-bold uppercase mb-2";
                    ...
                    <div>
                        ...
                        <div className="space-y-0.5">
                            ...
                            <div className="flex justify-between items-center text-[11px] font-bold mt-2 pt-1 border-t border-gray-400">
                                ...
                                <span className="w-10 text-center bg-gray-800 text-white mr-2">C4</span>
                    ...
                    <div>
                        ...
                        <div className="space-y-0.5">
                            ...
                            <div className="flex justify-between items-center text-[11px] font-bold mt-2 pt-1 border-t border-gray-400">
                                ...
                                <span className="w-10 text-center bg-gray-800 text-white mr-2">D4</span>
