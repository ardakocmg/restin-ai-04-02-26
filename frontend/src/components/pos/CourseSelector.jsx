...
const COURSE_COLORS = {
    1: { bg: 'bg-blue-500/20', border: 'border-blue-500', text: 'text-blue-400', activeBg: 'bg-blue-500', activeText: 'text-white' },
    2: { bg: 'bg-emerald-500/20', border: 'border-emerald-500', text: 'text-emerald-400', activeBg: 'bg-emerald-500', activeText: 'text-white' },
    3: { bg: 'bg-orange-500/20', border: 'border-orange-500', text: 'text-orange-400', activeBg: 'bg-orange-500', activeText: 'text-white' },
    4: { bg: 'bg-purple-500/20', border: 'border-purple-500', text: 'text-purple-400', activeBg: 'bg-purple-500', activeText: 'text-white' },
};
            ...
            {courses.map((course) => {
                ...
                return (
                    <button
                        ...
                        className={`
              min-w-[36px] h-[28px] rounded-full text-xs font-bold px-2
