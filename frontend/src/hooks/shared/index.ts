...
export type { PosConfig,StaffActivity,StaffMember,StaffStats } from './useStaffService';
...
export type { AccountingGroup,PaymentMethod,TaxProfile } from './useAccountingService';
