        ...
        <AnimatePresence>
            {modalOpen && (
                <motion.div
                    ...
                    style={{ backgroundColor: 'rgba(0, 0, 0, 0.7)', backdropFilter: 'blur(8px)' }} /* keep-inline */
                >
                    <motion.div
                    ...
                    >
                        ...
                        <div className="px-6 pt-6 pb-4 text-center">
                            ...
                            >
                                {isPasswordMode ? (
                                    <Lock className="w-7 h-7" style={{ color: accentColor }} /> /* keep-inline */
                                ) : (
                                    <Fingerprint className="w-7 h-7" style={{ color: accentColor }} /> /* keep-inline */
                                )}
                            </div>
                        ...
                        <div className="px-6 pb-3">
                            <div
                                ...
                                style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }} /* keep-inline */
                            >
                        ...
                        <form onSubmit={handleSubmit} className="px-6 pb-6 pt-2 space-y-4">
                            ...
                            {error && (
                                <div
                                    ...
                                    style={{ background: 'rgba(239, 68, 68, 0.1)', border: '1px solid rgba(239, 68, 68, 0.2)' }} /* keep-inline */
                                >
                            ...
                            <div className="flex gap-3 pt-1">
                                <button
                                    ...
                                    style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }} /* keep-inline */
                                >
                                    Cancel
                                </button>
                                <button
