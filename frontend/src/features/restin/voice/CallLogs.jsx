                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-white/5 hover:bg-transparent">
                                    ...
                                    <TableHead className="text-zinc-400">Guest Said</TableHead>
                                    <TableHead className="text-zinc-400">AI Response</TableHead>
                            ...
                            <TableBody>
                                {logs.map((log, i) => (
                                    <TableRow key={log.id || i} className="border-white/5 hover:bg-white/5">
                                        ...
                                        <TableCell className="text-zinc-400">{formatTime(log.created_at)}</TableCell>
                                        <TableCell className="text-zinc-400">{formatDuration(log.duration_seconds)}</TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell className="text-zinc-500 max-w-[250px] truncate text-xs">
                                            {log.transcript_out || '—'}
                                        </TableCell>
