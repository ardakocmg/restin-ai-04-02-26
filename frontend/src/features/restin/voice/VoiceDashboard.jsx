    ...
    return (
        <PageContainer title="Voice AI Receptionist" description="24/7 Phone Handling & Reservations">
            <div className="grid grid-cols-3 gap-6">
                {/* Status Card */}
                <Card className="bg-zinc-900 border-purple-500/20 shadow-lg shadow-purple-900/10">
                ...
                <Card className="bg-zinc-900 border-white/5">
                    <CardContent className="p-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-zinc-500 text-right">Knowledge Base: 65% Trained</p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-zinc-900 border-white/5">
                    <CardContent className="p-6">
                        ...
                        <p className="text-green-500 text-xs mt-1 flex items-center gap-1">
                            <Phone className="w-3 h-3" /> Saved ~3.5 hours of staff time
                        </p>
                    </CardContent>
                </Card>
            </div>
