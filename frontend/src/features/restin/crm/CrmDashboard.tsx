        ...
        <div className="p-6 space-y-6 bg-zinc-950 min-h-screen text-white">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-3">
                    ...
                    <Button className="bg-blue-600 hover:bg-blue-700 text-white font-bold border-none gap-2">
                        <Zap className="w-4 h-4" />
                        {t('restin.crm.boomerang')}
                    </Button>
                    <Button variant="outline" className="border-zinc-800 text-zinc-300 hover:bg-zinc-900 transition-colors gap-2">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                        ...
                        <div className="divide-y divide-zinc-800">
                            {isLoading ? (
                                <div className="p-8 text-center">
                                    ...
                                    <span className="text-zinc-500 text-sm">Loading guests...</span>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-6">
                                        <div className="text-right">
                                            <div className="font-mono font-bold text-white text-md">{c.spend || `€${(c.ltvCents / 100).toFixed(0)}`}</div>
                ...
                <div className="space-y-6">
                    <Card className="bg-gradient-to-br from-blue-600 to-blue-800 border-none text-white overflow-hidden relative shadow-xl shadow-blue-900/40">
                        ...
                        <CardContent className="space-y-4">
                            <p className="text-blue-100 text-sm leading-relaxed mb-4">
                                AI has detected <span className="font-black text-white">{summary?.high_risk_count || 0}</span> high-risk guests. Execute personalized re-engagement via Gemini now?
                            </p>
                            <Button
                    ...
                    <Card className="bg-zinc-900 border-zinc-800">
                        ...
                        <CardContent className="space-y-4">
                            {campaigns.length === 0 ? (
                                <p className="text-xs text-zinc-600 text-center py-4">No campaigns yet. Run Boomerang or seed data.</p>
                            ) : campaigns.map((camp, i) => (
                                <div key={camp.id || i} className="p-3 rounded-xl bg-zinc-950 border border-zinc-800 flex items-center justify-between group hover:border-zinc-700 transition-all">
                                    <div>
                                        <div className="text-sm font-bold text-zinc-200">{camp.name}</div>
                                        <div className="text-[9px] text-zinc-500 uppercase mt-1 font-bold">
