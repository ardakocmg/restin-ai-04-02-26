...
// Maltese translations (partial — extend as needed)
const mt: typeof en = {
    ...en,
    common: {
        ...en.common,
    ...
    pos: {
        ...en.pos,
        newOrder: 'Ordni Ġdida',
        table: 'Mejda',
        takeaway: 'Takeaway',
        delivery: 'Delivery',
        splitBill: 'Qassam il-Kont',
        payNow: 'Ħallas Issa',
        printReceipt: 'Ipprinta r-Riċevuta',
        subtotal: 'Subtotal',
        tax: 'VAT',
        grandTotal: 'Total Ġenerali',
        cashPayment: 'Flus',
        cardPayment: 'Karta',
    },
    errors: {
        ...en.errors,
        networkError: 'Żball fin-network. Iċċekkja l-konnessjoni tiegħek.',
        serverError: 'Żball fis-server. Erġa\' pprova.',
        unauthorized: 'Sessjoni skaduta. Erġa\' idħol.',
    },
};
