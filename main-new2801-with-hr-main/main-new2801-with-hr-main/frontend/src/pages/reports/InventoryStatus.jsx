        ...
        setTimeout(() => {
            setData({
                metrics: {
                    total_items: 450,
                    low_stock_alerts: 12,
                    waste_cost_week: 145.20,
                    inventory_value: 12500.00
                },
                waste_distribution: [
                    { name: 'Spoiled', value: 45 },
                    { name: 'Expired', value: 25 },
                    { name: 'Damaged', value: 15 },
                    { name: 'Overcooked', value: 15 },
                ],
                low_stock_items: [
                    { name: 'Flour (5kg)', current: 2, min: 5, unit: 'bags' },
                    { name: 'Tomatoes', current: 4.5, min: 10, unit: 'kg' },
                    { name: 'Mozzarella', current: 3, min: 8, unit: 'kg' },
                    { name: 'Olive Oil', current: 2, min: 6, unit: 'L' },
                ]
            });
            setLoading(false);
        }, 1000);
                ...
                <div className="card-dark p-6 rounded-2xl border border-white/10">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-white mt-1">€{data.metrics.inventory_value.toLocaleString()}</h3>
                        </div>
