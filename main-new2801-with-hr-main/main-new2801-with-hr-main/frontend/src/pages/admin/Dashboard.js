...
import {
  ...
  TrendingUp, DollarSign, Utensils, Monitor, ChefHat,
    ...
    >
      ...
      <StatsGrid columns={4}>
        ...
        <StatCard
          ...
          className={stats?.low_stock_items > 0 ? 'stat-card-danger' : ''}
        />
      </StatsGrid>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            ...
            <CardContent>
              <DataTable
                columns={[
                  ...
                  { key: 'total', label: 'Total', render: (row) => `€${row.total?.toFixed(2) || '0.00'}` }
                ]}
                data={recentOrders}
                loading={loading}
        ...
        <div className="space-y-6">
          {/* Alerts */}
          <Card className={stats?.low_stock_items > 0 ? 'stat-card-danger' : 'card-dark'}>
            <CardHeader>
            ...
            <CardContent>
              {stats?.low_stock_items > 0 ? (
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-zinc-900 border border-red-500/30">
