...
def create_admin_router():
    ...
    @router.get("/error-codes", dependencies=[Depends(require_owner)])
    ...
    @router.post("/logs/{log_id}/ack", dependencies=[Depends(require_owner)])
    ...
    @router.post("/backfill-all", dependencies=[Depends(require_owner)])
